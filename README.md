...
| [Screenshots](docs/screenshots.md) | How the three images at the top of this file are regenerated, and the month of fake walking they are taken against |
...
tools/screenshots.sh    regenerates the three images above (--check for staleness)
